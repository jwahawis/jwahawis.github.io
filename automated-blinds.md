...
### [](#bom)Shameless Amazon Associates BOM:
...
I noticed after a few days of use that the Raspberry Pi would disconnect from my AP and remain offline. [This guide](http://raspberrypi.stackexchange.com/a/5341) appears to have fixed my woes. As an Ubuntu user I've already wasted too much time trying to understand WiFi and Linux issues.
